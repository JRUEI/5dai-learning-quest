window.CourseData = {
  ...
  tasks: [
    ...
    { id: "whitepaper-01-06", group: "whitepaper", title: "閱讀 01-07：Agents 與 AI 開發演進", xp: 12 },
    { id: "whitepaper-07-12", group: "whitepaper", title: "閱讀 08-13：Tests、Context 與 Agent Skills", xp: 12 },
    { id: "whitepaper-13-18", group: "whitepaper", title: "閱讀 14-19：新 SDLC、品質與部署", xp: 12 },
    { id: "whitepaper-19-24", group: "whitepaper", title: "閱讀 20-25：維護、Factory 與 Harness", xp: 12 },
    { id: "whitepaper-25-30", group: "whitepaper", title: "閱讀 26-32：Orchestrator、經濟學與行動", xp: 12 },
  ...
  groups: {
    ...
    whitepaper: { label: "Whitepaper", description: "以 32 頁完整圖解簡報閱讀 Day 1 正式教材。" },
